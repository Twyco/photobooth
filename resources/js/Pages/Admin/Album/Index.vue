...
<template>
  <AdminLayout
    header="Alben"
  >
    <PaginatedTable :data="albums" :path="route('admin.albums.index')" :headers="tableHeaders"
                    create-route-name="admin.albums.create" title="Alle Alben"
                    edit-route-name="admin.albums.edit" show-route-name="admin.albums.show"
                    model-name="album"
