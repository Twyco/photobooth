          ...
          <Dropdown content-classes="bg-footer" width="w-fit">
            ...
            <template v-slot:content>
              <div class="flex flex-col">
                <Link
                  :href="route('admin.photobooth.edit', { photobooth: photobooth.id })"
                  class="px-8 py-1 md:py-2 text-primary bg-transparent hover:bg-highlight md:rounded-lg text-center"
                >
                  Bearbeiten
                </Link>
                <Link
                  :href="route('admin.photobooth.destroy', { photobooth: photobooth.id })"
                  method="delete"
        ...
        >
          ...
          <div class="flex gap-x-2">
            ...
            <Link
              ...
              :href="photobooth.active_album ? route('admin.album.show', { album: photobooth.active_album?.id }) : '#'"
